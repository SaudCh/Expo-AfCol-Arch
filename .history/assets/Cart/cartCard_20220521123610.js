        ...
        <View style={{ ...styles.card }}>
            ...
            <View style={{ marginLeft: 10 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    {subCategory.discount ? <Text style={{ fontSize: 15, textDecorationLine: "line-through" }}>Rs. {((price-0) * quantity).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}.00</Text> : <Text style={{ fontSize: 15 }}>Rs. {price}</Text>}
