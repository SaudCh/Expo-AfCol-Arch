...
export default function CartCard(props) {
    ...
    const { id, name, images, price, subCategory, quantity, incQuan, decQuan } = item
            ...
            <View style={{ flexDirection: "row", flex: 1, justifyContent: 'space-between' }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ ...globalStyle.hStack, ...globalStyle.border, borderRadius: 10 }}>
                        ...
                        <TouchableOpacity onPress={() => decQuan()} style={{ ...styles.decContainer }}>
                            <DecrementIcon size={20} />
                        </TouchableOpacity>
                        <Text style={{ fontSize: 14, paddingHorizontal: 10, }}>{quantity}</Text>
                        <TouchableOpacity onPress={() => incQuan()} style={{ ...styles.incContainer }}>
