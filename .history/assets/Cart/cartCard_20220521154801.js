...
import { changeNumberSystem } from '../Components/Functions/Global';
        ...
        <View style={{ ...styles.card }}>
            ...
            <View style={{ flexDirection: "row", flex: 1, justifyContent: 'space-between' }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', marginBottom: 5 }}>{subCategory.discount ? "Rs " + changeNumberSystem(actPrice * quantity) : changeNumberSystem(price)}</Text>
