...
export default function ContactInfo(props) {
    const { user, logout, email, setEmail, firstName, setFirstName, lastName, setLastName, country, setCountry, address, setAddress, city, setCity, postalCode, setPostalCode, phone, setPhone } = props
