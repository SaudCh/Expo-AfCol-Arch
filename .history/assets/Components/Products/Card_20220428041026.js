...
const Card = (props) => {
    ...
    return (
        <View style={{ ...styles.card }}>
            ...
            {discount == 0 ? <Text style={{ ...styles.productPrice }}> price </Text> : <Text style={{ ...styles.productPrice }}> price </Text>}
            <Text style={{ ...styles.productPrice }}>{discount == 0 ? null : price - discount}</Text>
        </View >
    )
}
