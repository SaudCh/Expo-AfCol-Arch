...
import { StyleSheet, TouchableOpacity, ToastAndroid, ActivityIndicator, FlatList, Button } from "react-native";
    ...
    return (
        <View style={{ paddingTop: 45, backgroundColor: '#fff', flex: 1 }}>
            ...
            <View style={{ position: 'absolute', bottom: 0 }}>
                {
                    user ?
                        <Button onPress={() => logout()} title="Logout" style={{ ...styles.btn, justifyContent: 'center' }}>
                            {/* <Text style={{ color: COLORS.dPink }}>Logout</Text> */}
                        </Button>
                        :
                        <Button onPress={() => navigate("Login")} title="Login" style={{ ...styles.btn, justifyContent: 'center' }}>
