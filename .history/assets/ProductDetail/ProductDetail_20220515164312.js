            ...
            <View style={{ padding: 10 }}>
                ...
                <List.AccordionGroup>
                    ...
                    <List.Accordion title="Accordion 3" id="3">
                        <List.Item title="SHIPPING DETAIL" >
                            <Text>150 Delivery Charges are applicable on complete order. We deliver all over Pakistan. For major cities, it's takes 3 to 4 working days, for other cities 4 to 6 working days.
                            </Text>
                        </List.Item>
                    </List.Accordion>
